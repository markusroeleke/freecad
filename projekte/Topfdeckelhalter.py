...
body = Box(Vector(-außen_breite/2, -außen_länge/2, 0),
           Vector(außen_breite/2, außen_länge/2, extrusion))

innen_unten = Box(Vector(body.w+wandung, body.s, 0),
                  Vector(body.e-wandung, body.s+innen_höhe_unten, extrusion))
body.solid = body.solid.cut(innen_unten.solid)


innen_oben = Box(Vector(body.w+wandung, body.n-wandung-innen_höhe_oben, 0),
                  Vector(body.e-wandung, body.n-wandung, extrusion))
body.solid = body.solid.cut(innen_oben.solid)


innen_oben_freischnitt = Box(Vector(body.w+wandung*2.5, body.n-wandung*2-innen_höhe_oben, 0),
                         Vector(body.e-wandung, body.n-wandung, extrusion))
body.solid = body.solid.cut(innen_oben_freischnitt.solid)

innen_mitte = Box(Vector(body.w, body.s+innen_höhe_unten+wandung, 0),
