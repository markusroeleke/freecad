...
u_scheibe_slide1 = Box(Vector(-u_durchmesser/2, -u_dicke/2, 0) + offset1,
...
offset2 = Vector(flugbrettchen.c+u_distanz/2, flugbrettchen.n-u_dicke, flugbrettchen.d)

u_scheibe_slide2 = Box(Vector(-u_durchmesser/2, -u_dicke/2, 0) + offset2,
