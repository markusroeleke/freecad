...
anschlag = Box(
    Vector(-anschlag_breite / 2, -anschlag_länge / 2, 0),
    Vector(anschlag_breite / 2, anschlag_länge / 2, anschlag_höhe),
)


waage = Box(
    Vector(anschlag.w, anschlag.s + anschlag_wandung, 0),
...
loch1 = Polyhedron(
    Polygon(
        Vector(anschlag.c, anschlag.m, anschlag.d),
        glas_durchmesser / 2,
        Vector(0, 0, 1),
        sides=6,
    ),
    Polygon(
        Vector(anschlag.c, anschlag.m, anschlag.u),
        glas_durchmesser / 2,
        Vector(0, 0, 1),
        sides=6,
    ),
