...
platte = Box(Vector(-länge/2, -breite/2, 0),
             Vector( länge/2,  breite/2, höhe))

länge = 32
breite = 7
aussparung = Box(Vector(-länge/2, platte.n-breite, 0),
                 Vector( länge/2, platte.n, höhe))
...
for x_offset, y_offset in [
    ...
    # platte oben
    senkung = Polyhedron(Polygon(Vector(x_offset, y_offset, platte.u-2.5), loch_durchmesser/2, Vector(0,0,1)), 
                         Polygon(Vector(x_offset, y_offset, platte.u), loch_durchmesser, Vector(0,0,1)))
    platte_oben.solid = platte_oben.solid.cut(senkung.solid)
# platte unten M3 löcher

schraube1 = Screw("schraube", "M3", 10, Vector(platte_unten.c+11, platte_unten.m-15.5, 3) )
schraube2 = Screw("schraube", "M3", 10, Vector(platte_unten.c-11, platte_unten.m-15.5, 3) )
schraube3 = Screw("schraube", "M3", 10, Vector(platte_unten.c   , platte_unten.m+15.5, 3) )
