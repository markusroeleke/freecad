...
anschlag = Box(
    Vector(-anschlag_länge / 2, -anschlag_breite_außen / 2, 0),
    Vector(anschlag_länge / 2, anschlag_breite_außen / 2, anschlag_höhe),
)

lasche = Box(
    Vector(anschlag.e - 10, anschlag.s - 90, anschlag.u - 20),
...
tuer = Polyhedron(
    Polygon(
        Vector(anschlag.c, anschlag.n - anschlag_wandung, z_offset),
        tuer_durchmesser / 2,
        Vector(0, 1, 0),
    ),
    Polygon(
        Vector(anschlag.c, anschlag.s + anschlag_wandung, z_offset),
        tuer_durchmesser / 2,
        Vector(0, 1, 0),
    ),
)
