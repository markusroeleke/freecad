...
lasche = Box(Vector(-lasche_länge/2, -lasche_breite_außen/2, 0),
               Vector(lasche_länge/2,  lasche_breite_außen/2,  lasche_höhe),)

z_offset = lasche.d + rohr_durchmesser/2 + lasche_wandung
rohr = Polyhedron(Polygon(Vector(lasche.c, lasche.n, z_offset), rohr_durchmesser/2, Vector(0,1,0)), 
                  Polygon(Vector(lasche.c, lasche.s, z_offset), rohr_durchmesser/2, Vector(0,1, 0)))

loch_durchmesser = 4.1
loch = Polyhedron(Polygon(Vector(lasche.c, lasche.m, lasche.u), loch_durchmesser/2, Vector(0,0,1)), 
                  Polygon(Vector(lasche.c, lasche.m, lasche.d), loch_durchmesser/2, Vector(0,0,1)))
